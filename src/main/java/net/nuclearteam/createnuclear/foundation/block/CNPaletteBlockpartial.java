...
public abstract class CNPaletteBlockpartial<B extends Block> {
    ...
    public @NonnullType BlockBuilder<B, CreateRegistrate> create(String variantName, CNPaletteBlockPatten pattern,
                                                                 BlockEntry<? extends Block> block, CNPalettesStoneTypes variant) {
        String patternName = CreateNuclearLang.nonPluralId(pattern.createName(variantName));
    ...
    protected ResourceLocation getTexture(String variantName, CNPaletteBlockPatten pattern, int index) {
        return CNPaletteBlockPatten.toLocation(variantName, pattern.getTexture(index));
    }

    protected BlockBuilder<B, CreateRegistrate> transformBlock(BlockBuilder<B, CreateRegistrate> builder,
                                                               String variantName, CNPaletteBlockPatten pattern) {
    ...
    protected abstract void generateBlockState(DataGenContext<Block, B> ctx, RegistrateBlockstateProvider prov,
                                               String variantName, CNPaletteBlockPatten pattern, Supplier<? extends Block> block);
